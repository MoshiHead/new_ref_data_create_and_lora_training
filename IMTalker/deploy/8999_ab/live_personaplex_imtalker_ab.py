...
from FM_8999 import FMGenerator
...
from live_personaplex_cached import MoshiOnlyEngine
                        ...
                        if bool(getattr(args, "direct_reply_hidden", False)):
                            ...
                            if assistant_active:
                                if was_silent:
                                    ...
                                    print(
                                        f"[GPU] Transition from silence to assistant speech. "
                                        f"Clearing frame_q of size {q_size} "
